    ...
    return (
        <>
            ...
            <div className='lg:flex lg:justify-around '>
                <div data-aos="fade-right" className='border-4  w-96 h-64 text-center px-3 rounded-xl transition duration-500 ease-in-out hover:border-indigo-500'>
                ...
                <div data-aos="zoom-in-up" className='border-4 my-12 lg:my-0 w-96 h-64 text-center px-3 rounded-xl transition duration-500 ease-in-out hover:border-indigo-500'>
                ...
                <div data-aos="fade-left" className='border-4  w-96 h-64 text-center px-3 rounded-xl transition duration-500 ease-in-out hover:border-indigo-500'>
